...
import com.luofx.mvp.base.view.IBaseView;
 ...
 * 说明：
 */
public  class  BasePresenter<V extends IBaseView, T> extends BaseXPresenter<V>
        implements IBasePresenter, HttpResponseListener<T> {
