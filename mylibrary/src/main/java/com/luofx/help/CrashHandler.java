 ...
 * describe:
 */
public class CrashHandler implements Thread.UncaughtExceptionHandler, IBaseConstants {
...
//    }
    ...
    private boolean handleException(final Throwable ex) {
        ...
        //TODO 开启线程收集并上传个给服务器
        final MyBaseApplication myBaseApplication = (MyBaseApplication) mContext.getApplicationContext();
        ...
        String url = BASE_IP + "/api/smartsz/addapplog";
