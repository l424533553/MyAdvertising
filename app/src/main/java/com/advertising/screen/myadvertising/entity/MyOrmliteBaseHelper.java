...
// */
//public class MyOrmliteBaseHelper extends OrmliteBaseHelper {
//    // 数据库名称
////    private static String DATABASE_NAME = "datatable.db";
//
//    public final static int version = 1;
////    // 本类的单例实例
////    private static MyOrmliteBaseHelper instance;
////
////
////    // 获取本类单例对象的方法
////    public static synchronized MyOrmliteBaseHelper getInstance(Context context) {
////        if (instance == null) {
////            synchronized (MyOrmliteBaseHelper.class) {
////                if (instance == null) {
////                    instance = new MyOrmliteBaseHelper(context);
////                }
////            }
////        }
////        return instance;
...
//                if (instance == null) {
//                    instance = new MyOrmliteBaseHelper(context,version);
//                }
//            }
//        }
//        return instance;
...
//
//    // 私有的构造方法
//    private MyOrmliteBaseHelper(Context context, int version) {
...
//        MyLog.mylog("数据库版本22222================ onCreate");
