        ...
        sysApplication.getThreadPool().execute(new Runnable() {
            ...
            public void run() {
                if (adUserBean != null) {
                    // 更新时间
                    adUserBean.setId(1);
                    boolean isSuccess = AdUserDao.getInstance(context).updateOrInsert(adUserBean);
                ...
                LiveBus.post(NOTIFY_LIVEBUS_KEY, String.class, NOTIFY_BASE_INFO, 500);
            }
        });
    }
                ...
                case VOLLEY_UPDATE_PRICE:
                    sysApplication.getThreadPool().execute(new Runnable() {
                        ...
                        public void run() {
                            ...
                            LiveBus.post(NOTIFY_LIVEBUS_KEY, String.class, NOTIFY_BASE_PRICE, 1000);
                        }
                    });
                    break;
                case VOLLEY_UPDATE_INSPECT:
                    sysApplication.getThreadPool().execute(new Runnable() {
                        ...
                        public void run() {
                            ...
                            LiveBus.post(NOTIFY_LIVEBUS_KEY, String.class, NOTIFY_BASE_INSPECT, 1000);
                        }
                    });
                    break;
                default:
