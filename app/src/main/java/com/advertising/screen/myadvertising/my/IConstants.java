package com.advertising.screen.myadvertising.my;
...
public interface IConstants {
    ...
    int NOTIFY_FRAGMENT_CHANGE = 9525;
...
//    int VOLLEY_UPDATE_GOOD = 4401;
    ...
    String NOTIFY_MESSAGE_CHANGE = "com.advertising.screen.myadvertising.my.helper.notify.message";

    String RADIO_VERSION_ST = "";// 固件版本  商通称
    String RADIO_VERSION_SX_7 = "";// 固件版本  香山 7寸屏
    String RADIO_VERSION_SX_15 = "";// 固件版本  香山  15.6寸屏

    String BANNER_NOTIFY = "com.axecom.iweight.carouselservice.datanotify";//图片已改变 需要进行刷新操作啦
    String BANNER_CHANGE = "com.axecom.iweight.carouselservice.datachange";//图片进行网络
    ...
    String ACTION_UNLOCK_SOFT = "com.advertising.screen.myadvertising.ui.activity.unlock";
