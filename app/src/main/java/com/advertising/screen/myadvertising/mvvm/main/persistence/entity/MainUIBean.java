...
public class MainUIBean {
    ...
    private final ObservableField<Integer> todayCount = new ObservableField<>();
    private final ObservableField<String> todayWeight = new ObservableField<>("0");
    private final ObservableField<Boolean> isWifi = new ObservableField<>();
    ...
    public ObservableField<Integer> getTodayCount() {
        return todayCount;
    }
