package com.advertising.screen.myadvertising.net;//package com.advertising.screen.myadvertising.net;
//
...
//                EventBus.getDefault().post(new BusEvent(BusEvent.REPORT_DEVICE_IS_ONLINE, true));
