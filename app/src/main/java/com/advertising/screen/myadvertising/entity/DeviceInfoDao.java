//package com.advertising.screen.myadvertising.entity;//package com.luofx.entity.dao;
//
//
...
//    MyOrmliteBaseHelper ormliteBaseHelper;
//
//    public DeviceInfoDao(Context context) {
//        try {
//            ormliteBaseHelper = MyOrmliteBaseHelper.getInstance(context.getApplicationContext());
