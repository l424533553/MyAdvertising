package com.axecom.smartweight.ui.activity;//package com.axecom.smartweight.ui.activity;
//
...
//import com.luofx.utils.system.TimerThreadUtil;
...
//
//public class MainActivityCopy extends MainBaseActivity implements VolleyListener, VolleyStringListener,
//        View.OnClickListener, View.OnLongClickListener, TimerThreadUtil.OnGetCurrentDateTimeListener {
//
...
//        //初始化 键盘 设置
//        initDigital();
//        weighUtils = new Weighter(handler);
//        weighUtils.open();
//
//        initHeartBeat();
//    }
...
//        new TimerThreadUtil(this).start();
//    }
//
//    @Override
...
//                                helper.askOrder(userInfo.getMchid(), askInfos.get(i).getBillcode(), MainActivityCopy.this, 4);
//                                Thread.sleep(100);
//                            }
//                        }
//                        Thread.sleep(3000);
...
//                                Toast.makeText(MainActivityCopy.this, "更新App失败,请联系运营人员", Toast.LENGTH_LONG).show();
//                            }
//                        });
//                        break;
//                    default:
...
//                if (NetWorkJudge.isNetworkAvailable(context)) {
//                    helper.commitDD(orderInfo, MainActivityCopy.this, 3);
//                }
//            }
//        });
//
