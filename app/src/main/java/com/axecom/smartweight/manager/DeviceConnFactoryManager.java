package com.axecom.smartweight.manager;//package com.axecom.smartweight.manager;
//
...
//                    String status = SysApplication.getContext().getString(R.string.str_printer_conn_normal);
//                    if (sendCommand == esc) {
//                        //设置当前打印机模式为ESC模式
//                        if (currentPrinterCommand == null) {
...
//                                SysApplication.getContext().sendBroadcast(intent);
//                            } else if (result == 1) {//查询打印机实时状态
//                                if ((buffer[0] & ESC_STATE_PAPER_ERR) > 0) {
//                                    status += " "+SysApplication.getContext().getString(R.string.str_printer_out_of_paper);
//                                }
//                                if ((buffer[0] & ESC_STATE_COVER_OPEN) > 0) {
//                                    status += " "+SysApplication.getContext().getString(R.string.str_printer_open_cover);
//                                }
//                                if ((buffer[0] & ESC_STATE_ERR_OCCURS) > 0) {
//                                    status += " "+SysApplication.getContext().getString(R.string.str_printer_error);
//                                }
//                                System.out.println(SysApplication.getContext().getString(R.string.str_state) + status);
////                                Toast.makeText(TAG, status, Toast.LENGTH_SHORT).show();
//                            }
//                        }
