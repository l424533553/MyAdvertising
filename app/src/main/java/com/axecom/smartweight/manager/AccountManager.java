...
import static com.axecom.smartweight.my.IConstants.USER_SCALES_ID;
import static com.axecom.smartweight.my.IConstants.USER_TOKEN;
...
public class AccountManager {
    ...
    public String getToken() {
        ...
        return SPUtils.getString(mCtx, USER_TOKEN, null);
    }

    public void saveToken(String token) {
        SPUtils.putString(mCtx, USER_TOKEN, token);
    }

    public void saveScalesId(String scalesId) {
        SPUtils.putString(mCtx, USER_SCALES_ID, scalesId);
    }
    ...
    public void loginOut() {
        SPUtils.putString(mCtx, USER_TOKEN, "");
    }
}
