...
//
//
//    public void submitOrder(final Context context) {
...
//                                    break;
//                            }
//                            SPUtils.putString(context, "print_bitmap", data.getPrint_code_img());
...
////                                }, 3000);//五百毫秒
////                            }
////                            LogWriteUtils.d(payNoticeBeanBaseEntity.getData().msg);
////                        }
////                    }
////
////                    @Override
